...
remember to git pull before you report a bug.
...
Dependencies include:
	...
	Getopt::Easy (for the command line options) [REQUIRED] (http://search.cpan.org/~jonbj/Getopt-Easy-0.1/lib/Getopt/Easy.pm)
